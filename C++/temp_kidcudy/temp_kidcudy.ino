...
int photoresistor = A1;                     //variable for storing photoresistor value
int threshold = 700;                        //threshold for night and day
String daytime="";
...
void loop() {
    ...
    lcd.print("KidCudi: ");                 //Print a label for the data
    lcd.print(daytime);                      //print the degrees Fahrenheit
